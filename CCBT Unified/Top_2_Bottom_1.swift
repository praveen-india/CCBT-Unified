...
class Top_2_Bottom_1: UIViewController {

    override func viewDidLoad() {
        
        super.viewDidLoad()
         self.title = "Top_2_Bottom_1"
...
extension Top_2_Bottom_1 {
    ...
    func setCustomView1Constraint(){
        ...
        self.customView1.heightAnchor.constraint(equalTo: self.view.heightAnchor, multiplier: 0.5, constant: -15).isActive = true
    ...
    func setCustomView3Constraint(){
        ...
        self.customView3.topAnchor.constraint(equalTo: self.customView1.bottomAnchor, constant: 10).isActive = true
        self.customView3.leadingAnchor.constraint(equalTo: self.customView1.leadingAnchor, constant: 0).isActive = true
        self.customView3.trailingAnchor.constraint(equalTo: self.customView2.trailingAnchor, constant: 0).isActive = true
        self.customView3.heightAnchor.constraint(equalTo: self.customView1.heightAnchor, multiplier: 0.9, constant: -94).isActive = true
