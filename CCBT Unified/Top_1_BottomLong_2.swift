...
extension Top_1_BottomLong_2 {
    ...
    func setCustomView1Constraint(){
        ...
        self.customView1.heightAnchor.constraint(equalTo: self.view.heightAnchor,multiplier: 0.35, constant: -74).isActive = true
    }
    ...
    func setContinueBtnConstraint(){
        ...
        self.continueBtn.widthAnchor.constraint(equalTo: self.customView2.widthAnchor, multiplier: 0.3, constant: 0).isActive = true
